package com.example.tilek_shambetaliev_hw5_2.ui.adapter
...
import com.example.tilek_shambetaliev_hw5_2.databinding.ItemOnBoardBinding
import com.example.tilek_shambetaliev_hw5_2.ui.OnBoard

class OnBoardAdapter( private val onClick: () -> Unit) : Adapter<OnBoardAdapter.OnBoardingViewHolder>() {
